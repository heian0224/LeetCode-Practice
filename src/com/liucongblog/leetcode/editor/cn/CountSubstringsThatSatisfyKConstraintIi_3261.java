...
public class CountSubstringsThatSatisfyKConstraintIi_3261{
    public static void main(String[] args) {
         Solution solution = new CountSubstringsThatSatisfyKConstraintIi_3261().new Solution();
    }
...
class Solution {
    ...
    public long[] countKConstraintSubstrings(String s, int k, int[][] queries) {
            if(queries == null || queries.length == 0) return new long[0];
            i =queries.length;
