...
<div><div>Related Topics</div><div><li>数组</li><li>动态规划</li><li>排序</li></div></div><br><div><li>👍 137</li><li>👎 0</li></div>
*/
 
package com.liucongblog.leetcode.editor.cn;
public class MinimumCostToCutAStick_1547{
    public static void main(String[] args) {
         Solution solution = new MinimumCostToCutAStick_1547().new Solution();
    }
